...
def uploadProgressReport():
    ...
    return render_template('UploadReportOutput.html', studentName=student[1], id=session['loggedInStudent'])
...
def approveCompany():
    ...
    if action == 'approve':
        ...
        return render_template('companyApproveOutput.html', company_list=name_list)
